...
const timeline = [
  {
    name: 'Fundación del equipo',
    description:
      'Un grupo de abogados visionarios se une para formar un equipo comprometido con la innovación en el ámbito legal. Con una pasión compartida por la justicia y la tecnología, nace la idea de crear Arxatec.',
    date: 'Agosto 2022',
    dateTime: '2021-08',
  },
  {
    name: 'Obtención de financiamiento',
    description:
      'Gracias a la visión clara y el compromiso del equipo, aseguran un financiamiento de $1.5 millones para desarrollar Arxatec, el sistema legal online que promete revolucionar la asesoría legal.',
    date: 'Diciembre 2024',
    dateTime: '2021-12',
  },
  {
    name: 'Lanzamiento de la versión beta',
    description:
      'Después de meses de desarrollo y pruebas, se lanza la versión beta de Arxatec. Los usuarios iniciales empiezan a experimentar la facilidad y eficiencia del sistema para gestionar sus necesidades legales.',
    date: 'Febrero 2025',
    dateTime: '2022-02',
  },
  {
    ...
    description:
      'Con el éxito de la versión beta, el equipo se expande para incluir más abogados especializados y desarrolladores de software, mejorando continuamente la plataforma.',
    date: 'Junio 2025',
    dateTime: '2022-12',
  },
]
        ...
        <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              Equipo de profesionales legales comprometidos a brindar servicios jurídicos de primer nivel a nuestros clientes.
              </h1>
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-lg leading-8 text-gray-600">
                Contamos con especialistas en diversas áreas del derecho, incluyendo derecho civil, penal, comercial y laboral. Nuestra misión es ofrecer asesoría y representación legal con integridad, profesionalismo y compromiso, asegurando siempre la mejor solución para nuestros clientes. Creemos en la justicia y trabajamos incansablemente para proteger los derechos e intereses de quienes confían en nosotros.
                </p>
              </div>
              <img
                src="https://www.bitacorarevista.com/web/wp-content/uploads/Mesa-de-trabajo-2-20-601.jpg"
                alt=""
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
              Podriamos colocar los logos Arxatec, La base, otras empresas de nuestar alianza.
          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Mision </h2>
                ...
                <p className="mt-6 text-base leading-7 text-gray-600">
                  Debemos de colocar fotos del equipo completo.
                  minus ut molestiae velit error quod. Excepturi quidem expedita molestias quas.
                  minus ut molestiae velit error quod. Excepturi quidem expedita molestias quas.
                </p>
              </div>
              <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                  <img
                    src="https://img.freepik.com/fotos-premium/equipo-abogados-negocios-trabajando-juntos-abogado-reunion_37714-531.jpg"
                    alt=""
                ...
                <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                  <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                    <img
                      src="https://images.unsplash.com/photo-1423592707957-3b212afa6733?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt=""
